<?php
  ...
  $serverUrls = array(
    ...
    array( 'url' => 'http://www.zki.dlr.de/arcgis/rest/services/vabene/edittest/FeatureServer', 'matchAll' => true, 'token' => '' ),
	...
	array( 'url' => 'http://www.zki.dlr.de/ArcGIS',		  					   'matchAll' => true, 'token' => '' ),  
    array( 'url' => 'http://www.zki.dlr.de/arcgisoutput/',   					   'matchAll' => true, 'token' => '' ),
	array( 'url' => 'http://www.zki.dlr.de/arcgiscache/', 				       'matchAll' => true, 'token' => '' ),
	array( 'url' => 'http://www.zki.dlr.de/arcgisjobs/',   					   'matchAll' => true, 'token' => '' ),
	array( 'url' => 'http://www.zki.dlr.de/arcgisindex/',   					   'matchAll' => true, 'token' => '' ),
	array( 'url' => 'http://www.zki.dlr.de/arcgisinput/',   					   'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://sampleserver1c.arcgisonline.com/arcgisoutput/',        'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://developers.arcgis.com/en/javascript/samples/exp_dragdrop/data/earthquakes.csv',        'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://www.zki.dlr.de/arcgis/rest/services/risk_indonesia/tsunami_risk_ass_coarse/',        'matchAll' => true, 'token' => '' )
