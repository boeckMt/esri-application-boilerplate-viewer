...
({
  viewer:{
    ...
    errors:{
      ...
      general: "Fehler",
      noConfig: "Es ist keine Konfiguration zur Erstellung der Karte vorhanden." + "\n" + "Bitte an den Administrator wenden!"
    }
  },
  tools:{
    basemap: {
    ...
    swipe: {
      title: "Layer überblenden",
      label: "Layer überblenden",
      start: "Start",
      end: "Ende"
    },
    time: {
    ...
    draw: {
      ...
      label: "Zeichenwerkzeug",
      info:"Form auswählen und auf der Karte zeichnen.",
      deselect:"abwählen",
      deselectTool:"abwählen der Zeichenform", 
      clear:"löschen",
      clearTool: "löschen aller Zeichnungen", 
      get:"KML speichern",
      getToolDe: "Grafik zeichnen dann speichern",
      getToolAk: "speichern",
      getKml:"Text in neuer Datei mit Endung .kml speichern",
      point: "Punkt",
      line: "Linie",
      rectangle: "Rechteck",
      polygon: "Vieleck",
      ellipsis: "Ellipse",
      project: "Alle Geometrien müssen vom selben Typ sein!"
    },
    legend: {
